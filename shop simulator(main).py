...
def pencilPurchase():
   ...
   if pencil_price == pencil:
       print('SOLD')
   elif pencil_price > pencil:
       print('BALANCE_ $',pencil_price-pencil,"\n\nTHANKS FOR SHOPPING AT CODIFY'S")
   elif pencil_price < pencil:
...
def cocacolaPurchase():
   ...
   if cocacola_price == coca_cola:
       print('SOLD')
   elif cocacola_price > coca_cola:
       print('BALANCE_ $',cocacola_price-coca_cola,"\n\nTHANKS FOR SHOPPING AT CODIFY'S")
   elif cocacola_price < coca_cola:
       print('Insufficient Funds')
...
def waterbottlePurchase():
   ...
   if waterbottle_price == water_bottle:
       print('SOLD')
   elif waterbottle_price > water_bottle:
       print('BALANCE_ $',waterbottle_price-water_bottle,"\n\nTHANKS FOR SHOPPING AT CODIFY'S")
   elif waterbottle_price < water_bottle:
       print('Insufficient Funds')
